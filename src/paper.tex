...
\begin{equation*}
  ...
  \begin{aligned}
    \Symbol{S} &\Arrow \Symbol{A} \\
    \Symbol{A} &\Arrow \Symbol{A} \Symbol{a} \Union \Null
  \end{aligned}
\end{equation*}
...
\begin{equation*}
  \begin{aligned}
    ...
    &= \FIRST(\FIRST(\Symbol{a}) \Seq \FIRST(\Symbol{b_1})) \cup \dots \cup \FIRST(\FIRST(\Symbol{a}) \Seq \FIRST(\Symbol{b_1}))\\
...
Ne glede koliko krat izpeljemo dalje $\Symbol{A}$ bo na začetku še vedno $\Symbol{a}$.
\begin{equation*}
  \Symbol{S} \Derive \Symbol{A}\begin{aligned}[t]
